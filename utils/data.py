...
class Logger():
    def __init__(
        ...
        print(self.t0)
        self.fileName = 'bcrnn={0}_loss={1}_K={2}_loupe={3}_ratio={4}_solver={5}_lambda012={6}_{7}_{8}_att={9}'.format( \
                         bcrnn, loss, K, loupe, ratio, solver, lambda0, lambda1, lambda2, att) + '.log'
